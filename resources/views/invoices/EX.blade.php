...
<head>
    ...
    $currency_prefix = "";
    if($invoiceData['currency'] == 'Dollar'){
    $currency_prefix = "$ ";
    }
...
<body>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr style="">
                        ...
                        <td style="border-bottom:none;border-top:none;">{{ $currency_prefix.number_format($item['dollar'], 2) }} </td>
                        <td style="border-bottom:none;border-top:none;">{{ $currency_prefix.number_format($item['dollar'] * $item['quantity'], 2) }}</td>
                    </tr>
                    @else
                    <tr>
                        <td style="border-bottom:none;border-top:none;height:29px;">{{ $index + 1 }}</td>
    ...
    <table>
        <tbody>
            <tr>
                ...
                <td style="width: 80px;background-color:#e0e0e0;text-align: center;"><strong>{{ $currency_prefix.number_format($invoiceData['invoice_total'], 2) }}</strong></td>
            </tr>
        </tbody>
    </table>
    ...
    <div class="info-section">
            ...
            <tr>
                <td style="padding-left: 0;">
                    <div class="bank-details">
                        ...
                        <p>Branch: {{ $invoiceData['bank_details']['branch'] }}</p>
        ...
        <p style="margin-top: 60px;">
            <center style="color: red;">Any transfer or currency exchange charges are payable by clients. please transfer according.</center>
        </p>
    </div>
