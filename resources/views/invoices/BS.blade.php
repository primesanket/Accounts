...
<body>
    ...
    <table>
        <tbody>
            <tr>
                <td style="background-color:#e0e0e0;">Rs.In Words: {{ $invoiceData['total_amount_in_words'] }} Only</td>
                <td style="width: 80px;border-right:none;text-align: center;background-color:#e0e0e0;">Invoice Total</td>
                <td style="width: 80px;background-color:#e0e0e0;text-align: center;"><strong>{{ number_format($invoiceData['invoice_total'], 2) }}</strong></td>
            </tr>
        </tbody>
    </table>

    <div class="info-section" style="margin-top: 90px;">
        <table class="no-border-table">
            <tr>
                <td style="padding-left: 0;">
                    <div class="bank-details">
                        <p style="font-size: 14px;">Please make a cheque on the name of “MEHUL SURESHBHAI SAVALIYA”.</p>
                        <p style="font-size: 14px;margin-bottom:15px;margin-top: -5px;">For NEFT/RTGS Transfer in below bank account:</p>
                ...
                <td style="text-align: right;padding-right: 0;">
                    <div class="signature">
                        <p style="margin-top: 65px;padding-top:50px;font-size:14px;">Signed By &nbsp;_________________</p>
                    </div>
                </td>
            </tr>
        </table>
