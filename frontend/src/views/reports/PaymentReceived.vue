    ...
    methods: {
        ...
        async fetchBootData() {
            try {
                ...
                const [parties, expense_types, expense_accounts] =
                    await Promise.all([
            ...
            if (isValid) {
                try {
                    ...
                    const formData = {
                        ...
                        expense_type_id: this.form.expense_type_id?.id || null,
                        expense_account_id: this.form.receiver_id?.id || null,
                        party_id: this.form.party_id?.id || null,
                        sale_id: this.form.sale_id?.id || null,
                    };

                    const response = await apiClient.post(
                        `/report/payment_received`,
                        formData,
                        {
                            responseType: "blob",
                        }
