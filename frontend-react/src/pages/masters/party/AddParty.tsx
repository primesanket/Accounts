...
import { createParty } from '@/services/admin/party';
...
const AddParty: React.FC = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: formValidation.addParty,
    ...
    return (
        <>
            <PageTitle title="Add Party" isBackButtonAllow={true} className="mb-5" />
            <div className="intro-y col-span-12 lg:col-span-6">
                <form onSubmit={formik.handleSubmit}>
                    ...
                    <FormButton label="Submit" size="sm" type="submit" loading={loading} className='mt-5' />
                </form >
            </div >
        </>
    )
